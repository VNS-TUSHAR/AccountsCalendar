...
//String password = "root";
    //   String  DbName="BSNLRCS";
//    String DbName = "VODARCS";

    String DbName = "AccountsInfo";
    ...
    public void getCon(String dbname) {
        ...
        try {
            ...
            conn = DriverManager.getConnection(url + dbname + "?autoReconnect=true&allowLoadLocalInfile=true&useSSL=false&allowPublicKeyRetrieval=true&useUnicode=true&characterEncoding=UTF-8", userName, password);
        } catch (Exception ex) {
