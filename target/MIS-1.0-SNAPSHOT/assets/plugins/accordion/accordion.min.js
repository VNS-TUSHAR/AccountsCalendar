! function(e) {
    ...
    e.fn.accordionjs = function(c) {
        ...
        var o = function() {
            n.create(), n.openOnClick(), e(window).on("load", function() {
                n.openOnHash()
        ...
        return this.openSection = function(c, n) {
            e(document).trigger("accjs_before_open_section", [c]), "function" == typeof i.beforeOpenSection && i.beforeOpenSection.call(this, c), n = n >= 0 ? n : i.slideSpeed;
            var t = c.children().eq(1);
            t.slideDown(n, function() {
                e(document).trigger("accjs_open_section", [c]), "function" == typeof i.openSection && i.openSection.call(this, c)
            }), c.addClass("acc_active")
        }, this.closeSection = function(c, n) {
            e(document).trigger("accjs_before_close_section", [c]), "function" == typeof i.beforeCloseSection && i.beforeCloseSection.call(this, c), n = n >= 0 ? n : i.slideSpeed;
            var t = c.children().eq(1);
            t.slideUp(n, function() {
                e(document).trigger("accjs_close_section", [c]), "function" == typeof i.closeSection && i.closeSection.call(this, c)
            ...
            if (e.each(c, function(c, t) {
                ...
                for (var o = i.activeIndex, s = 0; s < o.length; s++) n.openSection(c.eq(o[s] - 1), 0);
            else i.activeIndex > 1 ? n.openSection(c.eq(i.activeIndex - 1), 0) : !1 !== i.activeIndex && n.openSection(c.eq(0), 0)
        }, this.createSingleSection = function(c) {
            var n = c.children();
            c.addClass("acc_section"), e(n[0]).addClass("acc_head"), e(n[1]).addClass("acc_content"), c.hasClass("acc_active") || c.children(".acc_content").hide()
