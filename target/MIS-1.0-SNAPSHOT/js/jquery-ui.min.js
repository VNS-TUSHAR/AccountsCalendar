...
! function(t) {
    ...
    k.ui = k.ui || {};
    k.ui.version = "1.12.1", k.extend(k.expr[":"], {
    ...
    var t, c, u, r, d, e, p, f, g, a, m, o, n, h, l, _, i, s, v, b, y, w = "ui-effects-",
        x = "ui-effects-style",
    ...
    function T(s) {
        var n = p(),
            o = n._rgba = [];
        return s = s.toLowerCase(), m(e, function(t, e) {
            var i = e.re.exec(s),
                i = i && e.parse(i),
                e = e.space || "rgba";
            if (i) return i = n[e](i), n[f[e].cache] = i[f[e].cache], o = n._rgba = i._rgba, !1
        }), o.length ? ("0,0,0,0" === o.join() && c.extend(o, r.transparent), n) : r[s]
    }
    ...
    k.effects = {
    ...
    }, a = p.support = {}, O = c("<p>")[0], m = c.each, O.style.cssText = "background-color:rgba(1,1,1,.5)", a.rgba = -1 < O.style.backgroundColor.indexOf("rgba"), m(f, function(t, e) {
        ...
        parse: function(n, t, e, i) {
            ...
            var o = this,
                s = c.type(n),
                a = this._rgba = [];
            return t !== u && (n = [n, t, e, i], s = "array"), "string" === s ? this.parse(T(n) || r._default) : "array" === s ? (m(f.rgba.props, function(t, e) {
                a[e.idx] = I(n[e.idx], e)
        ...
        transition: function(t, a) {
            ...
            return m(i.props, function(t, e) {
                var i = e.idx,
                    ...
                    n = l[i],
                    o = g[e.type] || {};
                null !== n && (null === s ? h[i] = n : (o.mod && (o.mod / 2 < n - s ? s += o.mod : o.mod / 2 < s - n && (s -= o.mod)), h[i] = I((n - s) * a + s, e)))
            }), this[e](h)
        },
        blend: function(t) {
        ...
        var e = t[0] / 360,
            ...
            i = s <= .5 ? s * (1 + i) : s + i - s * i,
            s = 2 * s - i;
        return [Math.round(255 * P(s, i, e + 1 / 3)), Math.round(255 * P(s, i, e)), Math.round(255 * P(s, i, e - 1 / 3)), t]
    }, m(f, function(h, t) {
        var o = t.props,
            a = t.cache,
            r = t.to,
        ...
        p.fn[h] = function(t) {
            ...
            var e, i = c.type(t),
                ...
                n = this[a].slice();
            return m(o, function(t, e) {
                t = s["object" === i ? t : e.idx];
                null == t && (t = n[e.idx]), n[e.idx] = I(t, e)
            }), l ? ((e = p(l(n)))[a] = n, e) : p(n)
        }, m(o, function(a, r) {
        ...
        m(t, function(t, o) {
            c.cssHooks[o] = {
                set: function(t, e) {
                    var i, s, n = "";
                    if ("transparent" !== e && ("string" !== c.type(e) || (i = T(e)))) {
        ...
        return this.queue(function() {
            ...
            s(), e = e.map(function() {
                return this.end = M(this.el[0]), this.diff = function(t, e) {
                    var i, s, n = {};
                    for (i in e) s = e[i], t[i] !== s && (_[i] || !k.fx.step[i] && isNaN(parseFloat(s)) || (n[i] = s));
                    return n
        ...
        addClass: (h = k.fn.addClass, function(t, e, i, s) {
            return e ? k.effects.animateClass.call(this, {
                add: t
            }, e, i, s) : h.apply(this, arguments)
        }),
        removeClass: (n = k.fn.removeClass, function(t, e, i, s) {
            return 1 < arguments.length ? k.effects.animateClass.call(this, {
                remove: t
            }, e, i, s) : n.apply(this, arguments)
        }),
        toggleClass: (o = k.fn.toggleClass, function(t, e, i, s, n) {
            return "boolean" == typeof e || void 0 === e ? i ? k.effects.animateClass.call(this, e ? {
                add: t
            } : {
                remove: t
            }, i, s, n) : o.apply(this, arguments) : k.effects.animateClass.call(this, {
                toggle: t
            }, e, i, s)
        }),
    ...
    }), k.expr && k.expr.filters && k.expr.filters.animated && (k.expr.filters.animated = (i = k.expr.filters.animated, function(t) {
        return !!k(t).data(C) || i(t)
        ...
        effect: function() {
            function t(t) {
                ...
                e.data(C, !0), h.push(i), o && ("show" === i || i === o && "hide" === i) && e.show(), o && "none" === i || k.effects.saveStyle(e), k.isFunction(t) && t()
            }
            ...
            function l(t) {
                ...
                s.mode = h.shift(), !1 === k.uiBackCompat || o ? "none" === s.mode ? (e[r](), i()) : n.call(e[0], s, function() {
                    e.removeData(C), k.effects.cleanUp(e), "hide" === s.mode && e.hide(), i()
                }) : (e.is(":hidden") ? "hide" === r : "show" === r) ? (e[r](), i()) : n.call(e[0], s, i)
            }
        },
        show: (b = k.fn.show, function(t) {
            if (H(t)) return b.apply(this, arguments);
            var e = S.apply(this, arguments);
            return e.mode = "show", this.effect.call(this, e)
        }),
        hide: (v = k.fn.hide, function(t) {
            if (H(t)) return v.apply(this, arguments);
            var e = S.apply(this, arguments);
            return e.mode = "hide", this.effect.call(this, e)
        }),
        toggle: (s = k.fn.toggle, function(t) {
            if (H(t) || "boolean" == typeof t) return s.apply(this, arguments);
            var e = S.apply(this, arguments);
        ...
        t.clipInit || (t.start = k(t.elem).cssClip(), "string" == typeof t.end && (t.end = z(t.end, t.elem)), t.clipInit = !0), k(t.elem).cssClip({
            top: t.pos * (t.end.top - t.start.top) + t.start.top,
            right: t.pos * (t.end.right - t.start.right) + t.start.right,
            bottom: t.pos * (t.end.bottom - t.start.bottom) + t.start.bottom,
            left: t.pos * (t.end.left - t.start.left) + t.start.left
        })
    }, y = {}, k.each(["Quad", "Cubic", "Quart", "Quint", "Expo"], function(e, t) {
        y[t] = function(t) {
    ...
    !1 !== k.uiBackCompat && (O = k.effects.define("transfer", function(t, e) {
        k(this).transfer(t, e)
    }));
    ...
    k.ui.keyCode = {
        ...
        TAB: 9,
        UP: 38
    }, k.ui.escapeSelector = (A = /([!"#$%&'()*+,./:;<=>?@[\]^`{|}~])/g, function(t) {
    ...
    function q(t, e, i) {
        return [parseFloat(t[0]) * (Y.test(t[0]) ? e / 100 : 1), parseFloat(t[1]) * (Y.test(t[1]) ? i / 100 : 1)]
    }

    function K(t, e) {
        return parseInt(k.css(t, e), 10) || 0
    }
    W = Math.max, E = Math.abs, F = /left|center|right/, R = /top|center|bottom/, L = /[\+\-]\d+(\.[\d]+)?%?/, B = /^\w+/, Y = /%$/, j = k.fn.position, k.position = {
        scrollbarWidth: function() {
            ...
            var t, e = k("<div style='display:block;position:absolute;width:50px;height:50px;overflow:hidden;'><div style='height:100px;width:auto;'></div></div>"),
                i = e.children()[0];
            return k("body").append(e), t = i.offsetWidth, e.css("overflow", "scroll"), t === (i = i.offsetWidth) && (i = e[0].clientWidth), e.remove(), N = t - i
        },
        ...
        if (!u || !u.of) return j.apply(this, arguments);
        u = k.extend({}, u);
        ...
        return _[0].preventDefault && (u.at = "left top"), p = e.width, f = e.height, g = e.offset, m = k.extend({}, g), k.each(["my", "at"], function() {
            ...
            1 === i.length && (i = F.test(i[0]) ? i.concat(["center"]) : R.test(i[0]) ? ["center"].concat(i) : ["center", "center"]), i[0] = F.test(i[0]) ? i[0] : "center", i[1] = R.test(i[1]) ? i[1] : "center", t = L.exec(i[0]), e = L.exec(i[1]), w[this] = [t ? t[0] : 0, e ? e[0] : 0], u[this] = [B.exec(i[0])[0], B.exec(i[1])[0]]
        }), 1 === y.length && (y[1] = y[0]), "right" === u.at[0] ? m.left += p : "center" === u.at[0] && (m.left += p / 2), "bottom" === u.at[1] ? m.top += f : "center" === u.at[1] && (m.top += f / 2), d = q(w.at, p, f), m.left += d[0], m.top += d[1], this.each(function() {
            var i, t, a = k(this),
                r = a.outerWidth(),
                h = a.outerHeight(),
                e = K(this, "marginLeft"),
                ...
                o = h + s + K(this, "marginBottom") + b.height,
                l = k.extend({}, m),
                c = q(w.my, a.outerWidth(), a.outerHeight());
            "right" === u.my[0] ? l.left -= r : "center" === u.my[0] && (l.left -= r / 2), "bottom" === u.my[1] ? l.top -= h : "center" === u.my[1] && (l.top -= h / 2), l.left += c[0], l.top += c[1], i = {
                ...
                p < r && E(e + i) < p && (o.horizontal = "center"), f < h && E(s + n) < f && (o.vertical = "middle"), W(E(e), E(i)) > W(E(s), E(n)) ? o.important = "horizontal" : o.important = "vertical", u.using.call(this, t, o)
            }), a.offset(k.extend(l, {
                using: t
            }))
        })
        ...
        flip: {
            left: function(t, e) {
                var i = e.within,
                    ...
                    a = -2 * e.offset[0];
                r < 0 ? ((s = t.left + l + i + a + e.collisionWidth - n - s) < 0 || s < E(r)) && (t.left += l + i + a) : 0 < h && (0 < (o = t.left - e.collisionPosition.marginLeft + l + i + a - o) || E(o) < h) && (t.left += l + i + a)
            },
            top: function(t, e) {
                var i = e.within,
                    ...
                    a = -2 * e.offset[1];
                r < 0 ? ((s = t.top + l + i + a + e.collisionHeight - n - s) < 0 || s < E(r)) && (t.top += l + i + a) : 0 < h && (0 < (o = t.top - e.collisionPosition.marginTop + l + i + a - o) || E(o) < h) && (t.top += l + i + a)
            }
        },
        flipfit: {
            left: function() {
    ...
    k.ui.position, k.fn.scrollParent = function(t) {
    ...
    k.cleanData = (V = k.cleanData, function(t) {
        ...
        for (var e, i, s = X.call(arguments, 1), n = 0, o = s.length; n < o; n++)
        ...
        _createWidget: function(t, e) {
            e = k(e || this.defaultElement || this)[0], this.element = k(e), this.uuid = $++, this.eventNamespace = "." + this.widgetName + this.uuid, this.bindings = k(), this.hoverable = k(), this.focusable = k(), this.classesElementLookup = {}, e !== this && (k.data(e, this.widgetFullName, this), this._on(!0, this.element, {
                remove: function(t) {
    ...
    k.widget, k.widget("ui.accordion", {
        version: "1.12.1",
        options: {
            active: 0,
            animate: {},
    ...
    k.widget("ui.autocomplete", {
        ...
        _suggest: function(t) {
            ...
            this._renderMenu(e, t), this.isNewMenu = !0, this.menu.refresh(), e.show(), this._resizeMenu(), e.position(k.extend({ of: this.element
    ...
    k.ui.droppable, k.widget("ui.progressbar", {
        ...
        _position: function() {
            this.menuWrap.position(k.extend({ of: this.button
            }, this.options.position))
        },
        close: function(t) {
        ...
        _refreshItems: function(t) {
            ...
            for (e = c.length - 1; 0 <= e; e--)
                for (o = c[e][1], i = 0, h = (a = c[e][0]).length; i < h; i++)(r = k(a[i])).data(this.widgetName + "-item", o), l.push({
                    item: r,
                    instance: o,
                    width: 0,
                    height: 0,
    ...
    k.widget("ui.tabs", {
        ...
        _findNextTab: function(t, e) {
            ...
            for (; - 1 !== k.inArray((i < t && (t = 0), t < 0 && (t = i), t), this.options.disabled);) t = e ? t + 1 : t - 1;
            return t
        },
